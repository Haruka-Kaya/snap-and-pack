...
/// 全UI文言。intl は使わず ja/en の2列マップで最小構成にする。
class S {
  static String t(AppLang l, String key) {
    final v = _m[key];
    if (v == null) return key;
    return l == AppLang.ja ? v[0] : v[1];
  }
  ...
  static const Map<String, List<String>> _m = {
    ...
    'photosHint': ['重なっている物は角度を変えて撮ると見つけやすくなります', 'Shoot hidden items from another angle'],
    ...
    'myItemsEmpty': ['まだ登録がありません。下から追加してください', 'Nothing yet. Add your items below'],
    ...
    'refPhotoHint': ['📷 で実物を登録すると判定精度が上がります', '📷 Register a photo to boost accuracy'],
